          ...
          <div class="card-body">
            ...
            <table class="table table-striped">
              <thead class="table-dark">
                <tr>
                  <th class="text-white">Color ID</th>
            ...
            if(response.status == 200){
                ...
                $.each(colors, function (key,value) { 
                    ...
                    <tr>
                        ...
                        <th>
                            <button type="button" onclick="ColorEdit(${value.id},'${value.name}','${value.color_code}',${value.status})" class=" btn btn-info  btn-sm" data-bs-toggle="modal" data-bs-target="#modalUpdateColor"><i class="mdi mdi-pencil-box-outline"></i></button>
                            <button type="button" onclick="ColorDelete(${value.id})" class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i></button>
                        </th>
                    </tr>
                    `;
                });
