      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
          <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
            ...
            <h3 class="text-Dark font-weight-semibold mb-0 mt-3">{{ Auth::user()?->name ?? '' }}</h3>
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
            <div class="dropdown-header text-center">
              ...
              <p style="text-transform: uppercase" class="mb-1 mt-3 font-weight-semibold">{{ Auth::user()?->name ?? '' }}</p>
              <p class="font-weight-light text-muted mb-0">{{ Auth::user()?->email ?? '' }}</p>
            </div>
           <center> <a class="dropdown-item" href="{{ route('auth.logout') }}">Logout<i class="dropdown-item-icon ti-power-off"></i></a></center>
          </div>
        </li>
      </ul>
